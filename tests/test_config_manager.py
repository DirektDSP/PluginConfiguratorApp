...
class TestConfigurationManager:
    ...
    def test_set_quick_start_updates_state(self):
        """set_quick_start should set the quick_start flag deterministically"""
        mgr = ConfigurationManager()
        assert mgr.set_quick_start(True)
        assert mgr.get_full_config()["quick_start"] is True
        assert not mgr.set_quick_start(False)
        assert mgr.get_full_config()["quick_start"] is False
