...
class ConfigManager:
    ...
    PRESET_SCHEMA: ClassVar[dict[str, dict[str, dict[str, Any]]]] = {
        ...
        "configuration": {
            ...
            "au_component_type": {"type": str, "default": "aufx"},
            "au_component_subtype": {"type": str, "default": "plug"},
            "au_component_manufacturer": {"type": str, "default": "Ddsp"},
            "au_version": {"type": str, "default": "1.0.0"},
            "clap_extensions": {"type": str, "default": "note-ports,state"},
            "clap_features": {"type": str, "default": "audio-effect"},
            "auv3_platform": {"type": str, "default": "iOS"},
